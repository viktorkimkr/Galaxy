...
let description = document.querySelectorAll('.merch-item-descr')
...
for(let i = 0; i < 4;  i += 1){
    description[i].innerHTML = name_description[i]
}

let price = document.querySelectorAll('.merch-item-price')
let name_price = [
    '1000',
    '1000',
    '2500',
...
for(let i = 0; i < 4; i += 1){
    price[i].innerHTML = name_price[i]
}
